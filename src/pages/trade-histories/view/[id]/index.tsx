...
import { getTradeHistoryById } from 'apiSdk/trade-histories';
import { TradeHistoryInterface } from 'interfaces/trade-history';

function TradeHistoryViewPage() {
          ...
          items={[
            {
              ...
              link: '/trade-histories',
            },
            {
              label: 'Trade History Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('trade_history', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/trade-histories/edit/${id}`} passHref legacyBehavior>
                    <Button
