...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`CoolTrading`}</title>

        <meta
          name="description"
          content="Welcome to CoolTrading, your ultimate destination for Bitcoin trading exchange. Transforming the way you trade, invest, and grow your cryptocurrency."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1518546305927-5a555bb7020d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiaXRjb2lufGVufDB8fHx8MTY5NTUxMzgwOHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@silverhousehd?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`André François McKenzie`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to CoolTrading, your ultimate destination for Bitcoin trading exchange. Transforming the way you trade, invest, and grow your cryptocurrency.`}
            </Text>
            <Box
