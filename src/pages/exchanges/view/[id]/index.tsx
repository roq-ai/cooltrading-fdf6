...
import { getExchangeById } from 'apiSdk/exchanges';
import { ExchangeInterface } from 'interfaces/exchange';
import { MarketListPage } from 'pages/markets';
import { TransactionListPage } from 'pages/transactions';

function ExchangeViewPage() {
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('exchange', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/exchanges/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="exchange" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
